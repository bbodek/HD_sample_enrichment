...
baseline_unenriched$CAP_eligible<-factor(ifelse(baseline_unenriched$CAP>cap.threshold,1,0))
baseline_unenriched$PIN_eligible<-factor(ifelse(baseline_unenriched$PIN>pin.threshold,1,0))
...
# create table one
y<-table1(~ sex + age + Race + TMS + SDMT + TFCS + DCL + TMS + SWR + PIN + CAP + 
